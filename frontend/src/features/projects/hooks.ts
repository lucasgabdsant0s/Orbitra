...
export function useCreateProject() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error?.response?.data?.message || t("toasts.project_create_error");
      toast.error(message);
    },
  });
}
...
export function useUpdateProject() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error?.response?.data?.message || t("toasts.project_update_error");
      toast.error(message);
    },
  });
}
...
export function useDeleteProject() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error?.response?.data?.message || t("toasts.project_delete_error");
      toast.error(message);
    },
  });
}
