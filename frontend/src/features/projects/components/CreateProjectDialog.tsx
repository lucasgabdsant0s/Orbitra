...
export function CreateProjectDialog({ trigger }: CreateProjectDialogProps) {
  ...
  const createProjectSchema = z.object({
    name: z.string().min(1, t('projects.create_dialog.validation.name_required')),
      ...
      <DialogContent className="sm:max-w-[425px] bg-popover/95 backdrop-blur-2xl border-border rounded-[2.5rem] text-popover-foreground">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 py-6">
          <div className="space-y-2">
            <Label htmlFor="name" className="text-muted-foreground font-medium ml-1">
          ...
          <div className="space-y-2">
            <Label htmlFor="description" className="text-muted-foreground font-medium ml-1">
