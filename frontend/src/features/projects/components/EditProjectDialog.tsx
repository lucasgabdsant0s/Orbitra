      ...
      <DialogContent className="sm:max-w-[425px] bg-popover/95 backdrop-blur-2xl border-border rounded-[2.5rem] text-popover-foreground">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 py-4">
          <div className="space-y-2">
            <Label htmlFor="edit-name" className="text-muted-foreground font-medium ml-1">
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-description" className="text-muted-foreground font-medium ml-1">
