...
export function useCreateTenant() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error?.response?.data?.message || t("toasts.tenant_create_error");
      toast.error(message);
    },
  });
}
...
export function useUpdateTenant() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error?.response?.data?.message || t("toasts.tenant_update_error");
      toast.error(message);
    },
  });
}
...
export function useDeleteTenant() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      const message =
        error?.response?.data?.message || t("toasts.tenant_delete_error");
      toast.error(message);
    },
  });
}
